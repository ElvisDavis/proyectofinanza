            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Datos de la Empresa</strong>
                    </div>
                    <div class="card-body">
                        <!-- Credit Card -->
                        <div id="pay-invoice">
                                ...
                                <form action="#" method="post" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="nombre_empresa" name="nombre_empresa" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="Alibama">
                                    </div>
                                    <div class="form-group has-success">
                                        <label for="cc-name" class="control-label mb-1">Correo</label>
                                        <input id="correo_empresa" name="correo_empresa" type="email" class="form-control cc-name valid"
